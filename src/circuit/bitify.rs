use crate::{
    circuit::bool::CBool, circuit::num::CNum, core::cs::ConstraintSystem, core::field::PrimeField,
    core::signal::Signal, native::num::Num,
};
...
pub fn c_from_bits_le<'a, CS: ConstraintSystem>(bits: &[CBool<'a, CS>]) -> CNum<'a, CS> {
